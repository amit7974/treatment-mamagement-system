...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/doctor4.jpg" class="d-block w-100" alt="" height="500px">
    </div>
    <div class="carousel-item">
      <img src="img/doctor2.png" class="d-block w-100" alt="" height="500px">
    </div>
    <div class="carousel-item">
...
<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" src="img/doc.jpeg" height="350px">
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Alxendra loris</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Naira Wiliam</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Paul Samuel</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
